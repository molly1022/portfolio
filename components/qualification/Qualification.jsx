        ...
        <div className="qualification__sections">
          ...
          >
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              ...
              <div>
                <h3 className="qualification__title">Google Cloud Professional Data Engineer</h3>
                <div className="qualification__calender">
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              <div>
                ...
                <span className="qualification__subtitle">University of California, Los Angeles (UCLA)</span>
                <div className="qualification__calender">
